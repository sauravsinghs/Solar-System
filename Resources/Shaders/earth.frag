// Fragment shader for Earth with day/night, specular, and clouds blending
// textureEarth: base color; textureEarthNight: citylights; textureSpecular: water mask; textureClouds: cloud layer
#version 330 core
