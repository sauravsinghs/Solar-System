...
#include <vector>
#include <glm/glm.hpp>
// Represents a drawable mesh backed by OpenGL VAO/VBOs.
// - Can be constructed from an OBJ file or raw position/UV/normal arrays
// - Provides simple procedural generators: ico-sphere and noisy "craggy" asteroid
class Mesh
{
public:
