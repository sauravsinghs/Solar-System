...
#include "Mesh.h"
#include "Texture.h"
// Creates and owns the GLFW window and OpenGL context; configures global GL state
// and offers minimal helpers to bind shaders and draw VAO-backed meshes with up to 4 textures.
class Window
{
public:
