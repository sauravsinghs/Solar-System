// Loads an image via stb_image and uploads it to an OpenGL 2D texture with mipmaps.
#include "Texture.h"
#include "glad/glad.h"
#include "stb_image.h"
#include <iostream>
...
Texture::Texture(std::string texturePath)
{
    ...
    if (data)
    {
        GLenum srcFormat = channelsCount == 4 ? GL_RGBA : GL_RGB;
        GLenum internalFormat = srcFormat; // simple mapping
